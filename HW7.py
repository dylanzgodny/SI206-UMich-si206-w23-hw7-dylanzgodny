...
# Your name: Dylan Zgodny 
# Your student id: 05101958
# Your email: dzgodny@umich.edu
# List who you have worked with on this project: Jade Stoler and Lily Wachtel 
import unittest
import sqlite3
import json
import os
...
def make_players_table(data, cur, conn):
    for player in data["squad"]:
        ...
        cur.execute("INSERT OR IGNORE INTO Players (id, name, position_id, birthyear, nationality) VALUES (?,?,?,?,?)",(player_id, player_name, player_position_id, player_dob, player_nationality))
    conn.commit()
## [TASK 2]: 10 points
